...
class FamousPeopleListActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        myAdapter.famousPeopleUpdateCallback = { movie->
            val intent = Intent(this, MainActivity::class.java)
    ...
    private fun deleteMovie(movie: FamousPeople) {
        db = FirebaseFirestore.getInstance()
        db.collection("famouspeople").document(movie.documentID ?: "")
            .delete()
            ...
            override fun onEvent(
                ...
                for(dc: DocumentChange in value?.documentChanges!!) {
                    if (dc.type == DocumentChange.Type.ADDED) {
                        val movie = dc.document.toObject(FamousPeople::class.java)
